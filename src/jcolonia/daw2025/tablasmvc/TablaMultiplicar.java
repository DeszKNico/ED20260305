...
/**
 * Representa una tabla de multiplicar para un número específico. Genera y
 * almacena las líneas de la tabla para mostrar o exportar.
 */
public class TablaMultiplicar {
	...
	/**
	 * Genera la tabla de multiplicar del número base. Cada línea tiene formato
	 * "número x i = resultado" para i = 1 a 10. Limpia la lista anterior antes de
	...
	/**
	 * Devuelve el número base de la tabla.
	 * 
	 ...
	 * @return true si la exportación fue correcta
	 */
	public boolean exportar(String ruta) {
		return ExportacionArchivo.guardar(ruta, this.toString());
	}
	...
	/**
	 * Devuelve la lista de líneas de la tabla para mostrar en pantalla. Actualmente
	 * es la misma que para exportación.
	 * 
	...
	/**
	 * Representación en texto completo de la tabla de multiplicar, con cada línea
	 * separada por salto de línea.
	 * 
